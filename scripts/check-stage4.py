...
COORDINATOR_TESTS = [
    ...
    "receipt_boundary_handoff_selects_probe_and_keeps_query_after_search",
    "reference_free_rounds_do_not_reconcile_or_unlock_verification_reserve",
    "receipt_boundary_pauses_unresolved_and_preserves_approval_wait",
    "active_verification_refreshes_host_query_without_another_continuation",
    ...
    "compaction_uses_only_reserved_verification_allowance",
    ...
    "provider_failure_preserves_receipt_verified_completion",
    "rejected_proposal_retries_use_fresh_receipts_and_fixed_correction_guidance",
    "rejected_proposal_does_not_restart_with_unresolved_effects",
...
HOST_TESTS = [
    ...
    "agent_host_rejects_unissued_read_references_without_unknown_effects",
    "agent_host_keeps_inspection_and_apply_available_after_unrelated_search",
...
LOGGING_TESTS = [
    ...
    "agent_logging_verification_hint_waits_for_effective_receipts",
    "agent_logging_repeat_recovers_from_prior_run_receipt_read",
